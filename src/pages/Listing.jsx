...
import { activeSearchingUtil } from "../util/activeSearchingUtil";

const Listing = () => {
  const { handleSearchVisibility, handleMainVisibility } =
    activeSearchingUtil();
  ...
  return (
    <div>
      ...
      <div
        id="search-result"
        className={`${handleSearchVisibility()} template`}
      >
        <SearchResult />
      </div>

      <main id="main-site" className={`${handleMainVisibility()}`}>
        ...
        >
          ...
          <div id="follow-us-posts" className="flex flex-wrap 1300:gap-[4px]">
